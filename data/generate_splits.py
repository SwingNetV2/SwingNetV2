...
train_split.to_pickle('/content/drive/MyDrive/Y_TRY/golfdb/data/train_split_1.pkl')
val_split.to_pickle('/content/drive/MyDrive/Y_TRY/golfdb/data/val_split_1.pkl')
